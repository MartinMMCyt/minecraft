...
console.log = function (...args) {
  ...
  { addr: "wss://vanillamc.org", name: "VanillaMC" },
  { addr: "wss://communistmc.xyz", name: "Communist MC" },
  ...
  { addr: "wss://startmyeducation.net/server", name: "SME MC" },
  { addr: "wss://play.ggsmp.net", name: "GG SMP" },
  ...
  { addr: "wss://30070.ddnod.es", name: "Skyblock" },
  { addr: "wss://mc.novanetwork.lol", name: "NovaNetwork" },
  { addr: "wss://pixelclient.xyz/mc", name: "Asspixel" },
  { addr: "wss://mc.sealcentral.co", name: "SealCraft + NootServer" },
  { addr: "wss://blobcraft.club", name: "BlobCraft" },
  { addr: "wss://play.shadownetwork.shop", name: "Shadow Network" },
  { addr: "wss://velcroftsmp.xyz", name: "VelcroftSMP" },
  { addr: "wss://server.dhyrk.com", name: "Yeag MC" },
  { addr: "wss://8b4t.org", name: "Jonarchy" },
  { addr: "wss://web.strawberrysmp.org/", name: "StrawberrySMP" },
  { addr: "wss://velcroftsmp.xyz", name: "VelcroftSMP" },
  { addr: "wss://pxy.mcst.host/auroranetwork", name: "Aurora Network" },
  { addr: "wss://hellsmp.snubby.top/server", name: "Hell SMP" },
  { addr: "wss://bendie.tuff.tf", name: "Bendies Cool Server" },
  { addr: "wss://mc.cubecraft.org", name: "Cubecraft smp " },
  { addr: "wss://eagler.plebmc.top", name: "PlebMc" },
  { addr: "wss://x.mess.eu.org", name: "MessCraftX" },
  { addr: "wss://play.avernusmc.net", name: "AvernusMC" },
  { addr: "wss://eagler.imcalledfyre.com", name: "Fyrecraft: Season 4 [BEDWARS] 1.8-1.12" },
  { addr: "wss://x.mess.eu.org", name: "MessCraftX" },
  { addr: "wss://eagler.plebmc.top", name: "PlebMc" },
  { addr: "wss://web.thanatos-network.xyz", name: "Thanatos-Network" },
  { addr: "wss://smp.zelimmc.com", name: "ZelimSMP" },
  { addr: "wss://craft.huntools-bot.xyz", name: "Huntools" },
  { addr: "wss://eagler.suckmycraft.online/", name: "SuckMyCraft" },
